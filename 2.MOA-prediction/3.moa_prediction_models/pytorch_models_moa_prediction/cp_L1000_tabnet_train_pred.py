...
class cp_L1000_tabnet_moa_train_prediction:
    
    """
    This function performs TabNet model training on the combined Cell painting & L1000 level-4 profiles and also 
    performs prediction on the hold-out test set. The model training includes running 5-Kfold cross validation on 
    ...
    def cp_L1000_tabnet_moa_train_pred(self):
        ...
        NFOLDS = 5
        ##dir names
        model_file_name = "cp_L1000_tabnet"
        model_dir_name = "cp_L1000_tabnet_model"
        trn_pred_name = 'cp_L1000_train_preds_tabnet'
        tst_pred_name = 'cp_L1000_test_preds_tabnet'
...
if __name__ == '__main__':
    args = parse_args()
    cp_L1000_tabnet = cp_L1000_tabnet_moa_train_prediction(args.data_dir, args.model_pred_dir, args.shuffle, args.epochs,
                                                           args.batch_size, args.learning_rate)
    cp_L1000_tabnet.cp_L1000_tabnet_moa_train_pred()