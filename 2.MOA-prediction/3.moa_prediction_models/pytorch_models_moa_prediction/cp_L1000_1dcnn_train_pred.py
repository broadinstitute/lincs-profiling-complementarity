...
class cp_L1000_1dcnn_moa_train_prediction:
    
    """
    This function performs 1D-CNN model training on the combined Cell painting & L1000 level-4 profiles and also 
    ...
    def cp_L1000_cnn_moa_train_prediction(self):
        ...
        hidden_size=4096
        ##dir names
        model_file_name = "cp_L1000_1dcnn"
        model_dir_name = 'cp_L1000_cnn_model'
        trn_pred_name = 'cp_L1000_train_preds_1dcnn'
        tst_pred_name = 'cp_L1000_test_preds_1dcnn'
...
if __name__ == '__main__':
    args = parse_args()
    cp_L1000_1dcnn = cp_L1000_1dcnn_moa_train_prediction(args.data_dir, args.model_pred_dir, args.shuffle, args.epochs,
                                                         args.batch_size, args.learning_rate)
    cp_L1000_1dcnn.cp_L1000_cnn_moa_train_prediction()