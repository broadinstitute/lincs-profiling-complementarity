...
plot_save_heatmap(df_median_scores.iloc[:75, :], 'cellpainting_figures', 'modz_heatmap_1.png')


# In[7]:


plot_save_heatmap(df_median_scores.iloc[75:160, :], 'cellpainting_figures', 'modz_heatmap_2.png')


# In[8]:


plot_save_heatmap(df_median_scores.iloc[160:, :], 'cellpainting_figures', 'modz_heatmap_3.png')
...
plot_p_vs_median(df_medians_p_vals, 'Modz Consensus', os.path.join('cellpainting_figures', 
                                                                   'modz_p_vs_medscores_plot.png'))
...
plot_p_vs_median_jointplot(df_medians_p_vals, 'Modz Consensus', 
                           os.path.join('cellpainting_figures', 'modz_p_vs_medscores_jointplot.png'))
...
plot_significant_moas(df_sign_moas, df_medians_p_vals, 
                      os.path.join('cellpainting_figures', 'modz_sign_moa_medscores_plot.png'))
