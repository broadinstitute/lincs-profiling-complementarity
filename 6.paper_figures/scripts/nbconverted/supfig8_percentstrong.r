...
output_figure_base <- file.path("figures", "supplementary", "figureS8_percentstrong")
...
for (extension in extensions) {
    ...
    cowplot::save_plot(output_file, sup_fig8_gg, base_width = 10, base_height = 14, dpi = 500)
}
