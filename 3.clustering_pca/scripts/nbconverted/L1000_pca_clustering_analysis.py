...
save_to_csv(df_silh, L1000_level4_path, 'L1000_silhouette_scores.csv')
save_to_csv(df_db, L1000_level4_path, 'L1000_db_scores.csv')
save_to_csv(df_bic, L1000_level4_path, 'L1000_bic_scores.csv')
